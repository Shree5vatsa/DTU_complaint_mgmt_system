...
INSERT INTO `user` (`name`, `email`, `password`, `role_id`, `department_id`, `status`, `date_created`) VALUES
('Administrator', 'admin@dtu.ac.in', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 
 (SELECT id FROM roles WHERE role_name = 'Administrator'), NULL, 'active', CURRENT_TIMESTAMP);
...
('Dr. Rajesh Kumar', 'boys.hostel.warden@dtu.ac.in', '$2y$10$wH6Qw6Qw6Qw6Qw6Qw6Qw6uQw6Qw6Qw6Qw6Qw6Qw6Qw6Qw6Qw6Qw6', 
 ...
 (SELECT id FROM departments WHERE code = 'HST'), 'active', CURRENT_TIMESTAMP),
...
('Prof. Rajeev Malhotra', 'hod.coe@dtu.ac.in', '$2y$10$hod123HashHere', 
 ...
 (SELECT id FROM departments WHERE code = 'COE'), 'active', CURRENT_TIMESTAMP),
('Prof. Deepika Mehta', 'hod.ece@dtu.ac.in', '$2y$10$hod123HashHere', 
 (SELECT id FROM roles WHERE role_name = 'HOD'), 
 (SELECT id FROM departments WHERE code = 'ECE'), 'active', CURRENT_TIMESTAMP);
...
('Dr. Sunita Sharma', 'sunita.sharma@dtu.ac.in', 
 ...
 (SELECT id FROM roles WHERE role_name = 'Teacher'), 'active', CURRENT_TIMESTAMP),
...
('Rahul Kumar', 'rahul.kumar@dtu.ac.in', '2K21/CO/123', 
 ...
 (SELECT id FROM roles WHERE role_name = 'Student'), 'active', CURRENT_TIMESTAMP),
